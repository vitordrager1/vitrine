  ...
  return (
    ...
    > 
      <Flex minWidth='max-content' alignItems='center' gap='2' justifyContent={"space-between"} height={"70px"}>
        ...
        >
          <Box>''
            <Heading><Link href="/">LOJA DO ZÈ </Link></Heading>
          </Box>
          <Spacer/>
          <ButtonGroup>
          ...
          <Menu>
              ...
              <MenuList>
                <MenuGroup>
                  <MenuItem><Link href="/categoria/1">Informática</Link></MenuItem>
                  <MenuItem><Link href="/categoria/3">Tv e Vídeo</Link></MenuItem>
